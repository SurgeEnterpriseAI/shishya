// /exams — Entrance & Government Exams section landing.
//
// This page WAS the site root (/). Moved here in the Phase 1 navigation
// restructure so the new homepage (/) can position Shishya as a full
// lifecycle platform. Content is unchanged: same exam picker, same live
// counters strip, same upcoming-exams left rail, same discussions right
// rail. URL is the only thing that changed.
    ...
    <footer className="border-t border-ink-200 bg-white py-10">
      <div className="container-prose space-y-4">
        <p className="max-w-3xl text-center text-xs text-ink-600 sm:text-left">
          Shishya is a free, community-verified preparation platform for
          India&apos;s entrance and government exams — JEE, NEET, UPSC, SSC,
          IBPS, RRB, GATE, CAT, all state PSCs, all TETs. No ads. No agents.
          No affiliates. Education is a right.
        </p>
