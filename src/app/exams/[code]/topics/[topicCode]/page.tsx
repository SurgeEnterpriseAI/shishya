      ...
      <section className="container-prose py-8 sm:py-10">
        ...
        {notes ? (
          ...
          <div className="mt-8 rounded-md border border-dashed border-ink-300 bg-white px-5 py-6">
            ...
            <Link
              rel="nofollow" href={`/chat?examCode=${code}&topicCode=${encodeURIComponent(topic.code)}&seed=${encodeURIComponent(`Teach me ${topic.name} for ${exam.shortName} — concepts, formulas, common mistakes, and a few examples.`)}`}
        ...
        <section className="mt-10 rounded-md border border-saffron-200 bg-saffron-50/60 p-5">
          ...
          <ul className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-2">
            {([
              ...
              <li key={key}>
                <Link
                  rel="nofollow" href={`/chat?examCode=${code}&topicCode=${encodeURIComponent(topic.code)}&seed=${encodeURIComponent(q)}`}
          ...
          <Link
            rel="nofollow" href={`/chat?examCode=${code}&topicCode=${encodeURIComponent(topic.code)}&seed=${encodeURIComponent(`I'm studying ${topic.name} for ${exam.shortName}. Be my tutor for this topic.`)}`}
        ...
        {practiceQs.length > 0 && (
          <section className="mt-10">
            ...
            <Link
              rel="nofollow" href={`/chat?examCode=${code}&topicCode=${encodeURIComponent(topic.code)}&seed=${encodeURIComponent(
