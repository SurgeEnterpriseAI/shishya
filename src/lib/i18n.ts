...
export const dict = {
  en: {
    ...
    "land.title": "Find your exam.",
    "land.title.accent": "Prepare free.",
    "land.subtitle": "India's top 20 exams. AI-built mocks. A simple loop until you're ready.",
    "land.search.placeholder": "Search your exam — SSC, NEET, JEE, UPSC, CAT…",
  ...
  hi: {
    ...
    // ── new search-first landing
    "land.title": "अपनी परीक्षा खोजिए।",
    "land.title.accent": "मुफ़्त तैयारी कीजिए।",
    "land.subtitle": "भारत की शीर्ष 20 परीक्षाएँ। AI-निर्मित मॉक। तब तक चलने वाला सरल चक्र — जब तक आप तैयार न हों।",
    "land.search.placeholder": "अपनी परीक्षा खोजें — SSC, NEET, JEE, UPSC, CAT…",
