...
export const COLLEGES: College[] = [
  ...
  // ── Expansion: IIITs ─────────────────────────────────────────────────
  {
    ...
    city: "Hyderabad", state: "TS", type: "Autonomous", established: 1998,
    streams: ["engineering", "research"],
    nirf: { engineering: 47 },
    website: "https://www.iiit.ac.in",
    blurb: "Autonomous IIIT focused entirely on computer science and electronics. Admission via JEE Main + UGEE (their own test). Top-tier CS placement track for a non-IIT.",
  },
  {
    slug: "iiit-allahabad",
    name: "Indian Institute of Information Technology Allahabad",
    shortName: "IIIT Allahabad",
    city: "Prayagraj", state: "UP", type: "Central", established: 1999,
    streams: ["engineering"],
    nirf: { engineering: 84 },
    website: "https://www.iiita.ac.in",
    blurb: "The first IIIT to be set up as a centrally-funded institute. CSE and ECE focused — admission via JEE Main.",
  },
  {
    slug: "iiit-bangalore",
    name: "International Institute of Information Technology Bangalore",
    shortName: "IIIT Bangalore",
    city: "Bengaluru", state: "KA", type: "Autonomous", established: 1999,
    streams: ["engineering"],
    nirf: {},
    website: "https://www.iiitb.ac.in",
    blurb: "Bengaluru's tech-policy + technology institute. Mostly PG focused (MTech, MSc by Research, integrated MTech). Strong tie-ins with the Bengaluru tech ecosystem.",
  },

  // ── IISERs (research universities) ──────────────────────────────────
  {
    slug: "iiser-pune",
    name: "Indian Institute of Science Education and Research, Pune",
    shortName: "IISER Pune",
    city: "Pune", state: "MH", type: "Central", established: 2006,
    streams: ["research", "university"],
    nirf: {},
    website: "https://www.iiserpune.ac.in",
    blurb: "Centrally-funded research-and-undergraduate institute. 5-year integrated BS-MS programme; admission via IISER Aptitude Test (IAT) or KVPY successor channels.",
  },
  {
    slug: "iiser-kolkata",
    name: "Indian Institute of Science Education and Research, Kolkata",
    shortName: "IISER Kolkata",
    city: "Mohanpur", state: "WB", type: "Central", established: 2006,
    streams: ["research", "university"],
    nirf: {},
    website: "https://www.iiserkol.ac.in",
    blurb: "First IISER in eastern India. Strong interdisciplinary sciences and the only IISER offering a BS in Earth Sciences.",
  },
  {
    slug: "iiser-mohali",
    name: "Indian Institute of Science Education and Research, Mohali",
    shortName: "IISER Mohali",
    city: "Mohali", state: "PB", type: "Central", established: 2007,
    streams: ["research", "university"],
    nirf: {},
    website: "https://www.iisermohali.ac.in",
    blurb: "North India's IISER, particularly strong in mathematics and physics. Hosted India's first quantum computing PhD programme.",
  },
  ...
  // ── More engineering ────────────────────────────────────────────────
  {
    ...
    city: "Gandhinagar", state: "GJ", type: "Central", established: 2008,
    streams: ["engineering", "research"],
    nirf: { engineering: 22 },
    website: "https://www.iitgn.ac.in",
    blurb: "Newer IIT with a heavily project-based undergraduate curriculum. Strong materials science and the only IIT offering a BTech in materials engineering as a flagship.",
  },
  {
    slug: "iit-jodhpur",
    name: "Indian Institute of Technology Jodhpur",
    shortName: "IIT Jodhpur",
    city: "Jodhpur", state: "RJ", type: "Central", established: 2008,
    streams: ["engineering", "medical"],
    nirf: { engineering: 27 },
    website: "https://www.iitj.ac.in",
    blurb: "Rajasthan's IIT, expanding into healthcare engineering with an upcoming AIIMS-IIT-J joint MBBS-BTech programme. Strong AI/ML and biotechnology output.",
  },
  {
    slug: "nit-calicut",
    name: "National Institute of Technology Calicut",
    shortName: "NIT Calicut",
    city: "Kozhikode", state: "KL", type: "Central", established: 1961,
    streams: ["engineering"],
    nirf: { engineering: 25 },
    website: "https://www.nitc.ac.in",
    blurb: "Kerala's NIT, formerly the Calicut REC. Strong civil, mechanical and computer science programmes; the architecture course is among the most competitive in the NIT system.",
  },
  {
    slug: "iit-ropar",
    name: "Indian Institute of Technology Ropar",
    shortName: "IIT Ropar",
    city: "Rupnagar", state: "PB", type: "Central", established: 2008,
    streams: ["engineering", "research"],
    nirf: { engineering: 23 },
    website: "https://www.iitrpr.ac.in",
    blurb: "Punjab's IIT. Particularly strong in CSE and the Centre of Excellence in AI. Newer campus on the Sutlej river.",
  },
  {
    slug: "iit-bhubaneswar",
    name: "Indian Institute of Technology Bhubaneswar",
    shortName: "IIT Bhubaneswar",
    city: "Bhubaneswar", state: "OD", type: "Central", established: 2008,
    streams: ["engineering"],
    nirf: { engineering: 28 },
    website: "https://www.iitbbs.ac.in",
    blurb: "Odisha's IIT. Strong civil, mechanical and a relatively new aerospace engineering programme. Coastal-engineering focus given the state's geography.",
  },
  ...
  // ── More management ─────────────────────────────────────────────────
  {
    ...
    city: "Shillong", state: "ML", type: "Central", established: 2007,
    streams: ["management"],
    nirf: { management: 27 },
    website: "https://www.iimshillong.ac.in",
    blurb: "The first IIM in north-east India. The PGP curriculum has a notable sustainability and rural-development focus, mirroring Meghalaya's location.",
  },
  {
    slug: "iim-trichy",
    name: "Indian Institute of Management Tiruchirappalli",
    shortName: "IIM Trichy",
    city: "Tiruchirappalli", state: "TN", type: "Central", established: 2011,
    streams: ["management"],
    nirf: { management: 13 },
    website: "https://www.iimtrichy.ac.in",
    blurb: "Tamil Nadu's IIM. Newer batch but strong placement track record especially in BFSI and consulting.",
  },
  {
    slug: "mdi-gurgaon",
    name: "Management Development Institute, Gurgaon",
    shortName: "MDI Gurgaon",
    city: "Gurugram", state: "HR", type: "Autonomous", established: 1973,
    streams: ["management"],
    nirf: { management: 17 },
    website: "https://www.mdi.ac.in",
    blurb: "Non-IIM B-school with a particularly strong corporate-finance and energy-management track record. Admission via CAT.",
  },
  {
    slug: "spjimr-mumbai",
    name: "S. P. Jain Institute of Management & Research",
    shortName: "SPJIMR Mumbai",
    city: "Mumbai", state: "MH", type: "Autonomous", established: 1981,
    streams: ["management"],
    nirf: { management: 22 },
    website: "https://www.spjimr.org",
    blurb: "Bhavan's-run B-school. Operates its own admission test track separate from CAT for the PGDM (PGPM track also runs).",
  },

  // ── More medical ─────────────────────────────────────────────────────
  {
    slug: "amrita-medical-faridabad",
    name: "Amrita Institute of Medical Sciences",
    shortName: "Amrita Medical",
    city: "Kochi", state: "KL", type: "Private", established: 1998,
    streams: ["medical"],
    nirf: { medical: 8 },
    website: "https://www.amritahospitals.org",
    blurb: "Part of Amrita Vishwa Vidyapeetham. Major tertiary-care hospital in Kochi; MBBS admission via NEET UG.",
  },
  {
    slug: "kgmu-lucknow",
    name: "King George's Medical University",
    shortName: "KGMU Lucknow",
    city: "Lucknow", state: "UP", type: "State", established: 1911,
    streams: ["medical"],
    nirf: { medical: 12 },
    website: "https://www.kgmu.org",
    blurb: "Among India's oldest medical institutions. Now a full state medical university with MBBS admission via NEET UG state quota.",
  },
  {
    slug: "bhu-medical",
    name: "Institute of Medical Sciences, Banaras Hindu University",
    shortName: "IMS BHU",
    city: "Varanasi", state: "UP", type: "Central", established: 1960,
    streams: ["medical"],
    nirf: { medical: 7 },
    website: "https://www.bhu.ac.in/medical_science",
    blurb: "The medical faculty of BHU. MBBS admission via NEET UG. Strong reputation in Ayurveda and clinical specialties.",
  },
  ...
  // ── More NLUs ────────────────────────────────────────────────────────
  {
    ...
    city: "Gandhinagar", state: "GJ", type: "Central", established: 2003,
    streams: ["law"],
    nirf: { law: 9 },
    website: "https://www.gnlu.ac.in",
    blurb: "Gujarat's NLU. CLAT admission, particularly strong in international commercial law and a long-running diploma in cyber law.",
  },
  {
    slug: "nlu-jodhpur",
    name: "National Law University, Jodhpur",
    shortName: "NLU Jodhpur",
    city: "Jodhpur", state: "RJ", type: "Central", established: 1999,
    streams: ["law"],
    nirf: { law: 10 },
    website: "https://www.nlujodhpur.ac.in",
    blurb: "Rajasthan's NLU and the only NLU to require both science and commerce streams' graduates separately for the BBA-LLB programme.",
  },
  {
    slug: "rmnlu-lucknow",
    name: "Dr. Ram Manohar Lohiya National Law University",
    shortName: "RMNLU Lucknow",
    city: "Lucknow", state: "UP", type: "Central", established: 2005,
    streams: ["law"],
    nirf: { law: 12 },
    website: "https://www.rmlnlu.ac.in",
    blurb: "Uttar Pradesh's flagship NLU. CLAT admission; relatively newer NLU but with steadily improving rankings and a strong moot-court culture.",
  },

  // ── More universities ───────────────────────────────────────────────
  {
    slug: "vit-vellore-university",
    name: "VIT University",
    shortName: "VIT University",
    city: "Vellore", state: "TN", type: "Deemed", established: 2001,
    streams: ["university"],
    nirf: { university: 13 },
    website: "https://vit.ac.in",
    blurb: "The deemed university umbrella that operates VIT's multi-campus engineering ecosystem. Separate engineering page covers admission and NIRF Engineering rank.",
  },
  {
    slug: "christ-university",
    name: "Christ University",
    shortName: "Christ University",
    city: "Bengaluru", state: "KA", type: "Deemed", established: 1969,
    streams: ["university", "management"],
    nirf: { university: 35, management: 64 },
    website: "https://christuniversity.in",
    blurb: "Bengaluru's largest private deemed university. Particularly strong in BBA, BCom, psychology and the liberal-arts programme; multiple campuses across India.",
  },
  {
    slug: "symbiosis-pune",
    name: "Symbiosis International (Deemed University)",
    shortName: "Symbiosis Pune",
    city: "Pune", state: "MH", type: "Deemed", established: 1971,
    streams: ["university", "management", "law"],
    nirf: { university: 32, management: 19 },
    website: "https://www.symbiosis.ac.in",
    blurb: "Pune's flagship private deemed university with major management (SIBM), law (SLS), liberal-arts and design schools. Admission via SET / SNAP / SLAT depending on programme.",
  },
];
