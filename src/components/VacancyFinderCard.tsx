...
export function VacancyFinderCard({
  ...
  return (
    <Link
      href="/find-your-exam"
      className="group block overflow-hidden rounded-2xl border-2 border-saffron-300 bg-gradient-to-br from-saffron-50 via-amber-50 to-white p-5 shadow-sm transition-all hover:border-saffron-500 hover:shadow-md sm:p-6"
    >
