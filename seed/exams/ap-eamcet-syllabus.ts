// AP EAMCET / EAPCET (Andhra Pradesh Engineering Agricultural Medical CET) — full syllabus tree.
// Based on Andhra Pradesh State Board Class 11 + 12 (Intermediate) curriculum, NCERT-aligned.
...
//
// Run after seedExams: npx tsx seed/exams/ap-eamcet-syllabus.ts
...
export const apEamcetSyllabus: SubjectSeed[] = [
  // ── MATHEMATICS (80 Qs) ───────────────────────────────────────────────
  {
    code: "MATHEMATICS",
    name: "Mathematics",
    ...
    topics: [
      // Algebra
      { code: "math.functions", name: "Functions", description: "Types of functions, domain, range, composition, inverse, real-valued functions." },
      ...
      { code: "math.complex_numbers", name: "Complex Numbers", description: "Algebra of complex numbers, modulus, argument, polar form, geometrical representation." },
      ...
      { code: "math.permutations", name: "Permutations and Combinations", description: "Fundamental principle, nPr, nCr, applications." },
      ...
      // Trigonometry
      { code: "math.trig_ratios", name: "Trigonometric Ratios up to Transformations", description: "Trig identities, compound, multiple, sub-multiple angles, transformations." },
      ...
      { code: "math.product_vectors", name: "Product of Vectors", description: "Dot product, cross product, scalar/vector triple products, applications." },
      ...
      { code: "math.circle", name: "Circle", description: "Equation, position of a point, tangent, normal, chord of contact." },
      ...
      { code: "math.plane", name: "Plane", description: "Equation of plane in various forms, angle between planes, distance from a point." },
      // Calculus
  ...
  // ── PHYSICS (40 Qs) ───────────────────────────────────────────────────
  {
    ...
    topics: [
      ...
      { code: "phy.mech_fluids", name: "Mechanical Properties of Fluids", description: "Pressure, Pascal's law, Bernoulli's equation, viscosity, Stokes' law, surface tension." },
      ...
      { code: "phy.thermodynamics", name: "Thermodynamics", description: "Zeroth, first and second laws; isothermal, adiabatic processes; heat engines; Carnot cycle." },
  ...
  // ── CHEMISTRY (40 Qs) ─────────────────────────────────────────────────
  {
    ...
    topics: [
      ...
      { code: "chem.chemistry_everyday", name: "Chemistry in Everyday Life", description: "Drugs, antibiotics, soaps, food preservatives, polymers in daily life." },
  ...
  // ── BOTANY (40 Qs — BiPC Track) ───────────────────────────────────────
  {
    ...
    topics: [
      ...
      { code: "bot.plant_kingdom", name: "Plant Kingdom", description: "Algae, bryophytes, pteridophytes, gymnosperms, angiosperms — classification." },
      { code: "bot.morphology_plants", name: "Morphology of Flowering Plants", description: "Root, stem, leaf, inflorescence, flower, fruit, seed; floral diagrams." },
      { code: "bot.taxonomy_angiosperms", name: "Taxonomy of Angiosperms", description: "Systems of classification, families — Fabaceae, Solanaceae, Liliaceae." },
      { code: "bot.cell_unit", name: "Cell — The Unit of Life", description: "Cell theory, prokaryotic vs eukaryotic, organelles, cell wall, nucleus." },
      ...
      { code: "bot.mineral_nutrition", name: "Mineral Nutrition", description: "Essential elements, deficiency, nitrogen cycle, biological N-fixation." },
      ...
      { code: "bot.reproduction_plants", name: "Reproduction in Plants", description: "Modes of reproduction, sexual reproduction in flowering plants, double fertilization." },
      { code: "bot.genetics", name: "Genetics", description: "Mendelism, linkage, sex-linked inheritance, polygenic inheritance, mutations." },
      { code: "bot.molecular_biology", name: "Molecular Biology", description: "DNA structure, replication, transcription, translation, genetic code, regulation." },
      { code: "bot.biotech_applications", name: "Biotechnology and its Applications", description: "Genetic engineering, transgenic plants, GMOs, agriculture, RNAi." },
  ...
  // ── ZOOLOGY (40 Qs — BiPC Track) ──────────────────────────────────────
  {
    ...
    topics: [
      ...
      { code: "zoo.human_anatomy_2", name: "Human Anatomy and Physiology — II", description: "Body fluids and circulation; excretory products and elimination." },
      ...
      { code: "zoo.health_disease", name: "Human Health and Disease", description: "Pathogens, immunity, AIDS, cancer, drug abuse, vaccines." },
      { code: "zoo.biotech_human_welfare", name: "Biotechnology — Human Welfare", description: "Recombinant insulin, gene therapy, molecular diagnostics, transgenic animals." },
    ],
  },
];

export async function seedApEamcetSyllabus() {
  const exam = await prisma.exam.findUnique({ where: { code: "AP_EAMCET" } });
  if (!exam) {
    throw new Error("Run seedExams() first — AP_EAMCET exam not found.");
  }
  console.log(`Seeding AP EAMCET syllabus into exam ${exam.id}...`);

  let topicCount = 0;
  for (let sIdx = 0; sIdx < apEamcetSyllabus.length; sIdx++) {
    const s = apEamcetSyllabus[sIdx];
  ...
  console.log(`✓ Seeded AP EAMCET syllabus. Total topics: ${topicCount}`);
}

if (require.main === module) {
  seedApEamcetSyllabus()
    .catch((err) => {
      console.error(err);
      process.exit(1);
    })
